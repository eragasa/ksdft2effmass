...
- **Schema version:** `3`
- **Task ID:** `quantumespresso.simulations.pranab_das.wannier-silicon`
- **Status:** `blocked`
- **Status detail:** Wannier90 3.1.0 is installed and version-probed; this planned candidate remains blocked pending complete inputs, QE/Wannier interface compatibility, pseudopotential, resource estimate, and separate Wannier execution authorization.
...
- `wannier_tutorial_execution_authorization`
