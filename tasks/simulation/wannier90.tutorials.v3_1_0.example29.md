# Wannier90 3.1.0 example29: Platinum spin Hall conductivity
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example29`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example29`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example29` tutorial on platinum spin hall conductivity.
...
- Inventory the exact `examples/example29` source directory: 4 files with canonical path-and-content manifest SHA-256 `c043cf6d0518f29463f436b332ca14a766ccc7809fd8e7810b4b12ab23d26114`.
