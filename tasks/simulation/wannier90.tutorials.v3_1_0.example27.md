# Wannier90 3.1.0 example27: Silicon SCDM automated localization
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example27`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example27`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example27` tutorial on silicon scdm automated localization.
...
- Inventory the exact `examples/example27` source directory: 9 files with canonical path-and-content manifest SHA-256 `18f5c9d611494247f2c821c2641fdef2c33a0ce5451cffda4a6dfb84c0ea7baf`.
