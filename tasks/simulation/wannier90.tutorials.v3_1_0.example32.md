# Wannier90 3.1.0 example32: Tungsten automated projections
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example32`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example32`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example32` tutorial on tungsten automated projections.
...
- Inventory the exact `examples/example32` source directory: 6 files with canonical path-and-content manifest SHA-256 `7f724f5ca6f70f85c45d93b318cd32022518ab048f3f2182deaa34bb383f04ed`.
