# Wannier90 3.1.0 example07: Silane valence states
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example07`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example07`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example07` tutorial on silane valence states.
...
- Inventory the exact `examples/example07` source directory: 4 files with canonical path-and-content manifest SHA-256 `441067041215e94043f2cfc765d853dbeed955e8a4d6051366d5de29e27b5c29`.
