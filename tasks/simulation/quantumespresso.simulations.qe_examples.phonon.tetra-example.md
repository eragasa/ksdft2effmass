# QE 7.2 bundled PHonon tetra_example example
...
- **Schema version:** `3`
- **Task ID:** `quantumespresso.simulations.qe_examples.phonon.tetra-example`
- **Status:** `blocked`
- **Status detail:** Inventory-only Task for the bundled Quantum ESPRESSO 7.2 source group `PHonon/examples/tetra_example`. No script has been invoked by this Task. Exact source, executable, input, pseudopotential, dependency, resource, retention, and protected-execution preflights remain required.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the Quantum ESPRESSO 7.2 bundled example group `PHonon/examples/tetra_example` containing `PHonon/examples/tetra_example/run_example`.
...
- Inventory source group `PHonon/examples/tetra_example` and candidate script(s): `PHonon/examples/tetra_example/run_example`.
