# Wannier90 3.1.0 example15: Carbon-nanotube LCR transport
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example15`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example15`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example15` tutorial on carbon-nanotube lcr transport.
...
- Inventory the exact `examples/example15` source directory: 8 files with canonical path-and-content manifest SHA-256 `1215e5ed9b41cb33d5ca708b8e9e94f028a711c29b363760d58eda2e9588f4db`.
