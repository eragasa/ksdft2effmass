# Wannier90 3.1.0 example23: Silicon G0W0 band interpolation
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example23`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example23`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example23` tutorial on silicon g0w0 band interpolation.
...
- Inventory the exact `examples/example23` source directory: 10 files with canonical path-and-content manifest SHA-256 `d5e36cbd5cae9f757e42f62541a27c4d259f806b53f14084b71946bfa1169eef`.
