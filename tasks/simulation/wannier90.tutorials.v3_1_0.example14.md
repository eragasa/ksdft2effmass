# Wannier90 3.1.0 example14: Sodium-chain LCR transport
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example14`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example14`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example14` tutorial on sodium-chain lcr transport.
...
- Inventory the exact `examples/example14` source directory: 8 files with canonical path-and-content manifest SHA-256 `28a3c9772348279ce758185667ee53157aead44dede42a0fcf275e707cb2e855`.
