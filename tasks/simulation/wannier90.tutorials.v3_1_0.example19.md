# Wannier90 3.1.0 example19: Iron orbital magnetization
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example19`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example19`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example19` tutorial on iron orbital magnetization.
...
- Inventory the exact `examples/example19` source directory: 4 files with canonical path-and-content manifest SHA-256 `1f69bac6d990d028005a6f421210dec31ee978c68388fd377ccf402109da2242`.
