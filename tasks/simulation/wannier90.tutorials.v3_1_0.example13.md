# Wannier90 3.1.0 example13: Carbon nanotube transport
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example13`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example13`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example13` tutorial on carbon nanotube transport.
...
- Inventory the exact `examples/example13` source directory: 4 files with canonical path-and-content manifest SHA-256 `3632566262b6d81476a3f8d556f65310e05f8aed314962eeb396f3982c1045e2`.
