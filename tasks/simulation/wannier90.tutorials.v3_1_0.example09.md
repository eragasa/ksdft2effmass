# Wannier90 3.1.0 example09: Barium titanate
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example09`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example09`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example09` tutorial on barium titanate.
...
- Inventory the exact `examples/example09` source directory: 4 files with canonical path-and-content manifest SHA-256 `1702f5021e1532090544b6c2f441277f55c851f9900585a3efe091a76fd17807`.
