# Wannier90 3.1.0 example26: Gallium arsenide selective localization
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example26`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example26`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example26` tutorial on gallium arsenide selective localization.
...
- Inventory the exact `examples/example26` source directory: 4 files with canonical path-and-content manifest SHA-256 `d65f52b2e532e0fbd9ddfc28c3b19db148aa418976908461c0574c3de8684dc7`.
