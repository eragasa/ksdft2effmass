# Wannier90 3.1.0 example02: Lead four-state Fermi surface
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example02`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example02`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example02` tutorial on lead four-state fermi surface.
...
- Inventory the exact `examples/example02` source directory: 4 files with canonical path-and-content manifest SHA-256 `85e72e5cec1f85bdcef0b1ec7d7b1c0528bc665bfee8c4e0548e6b9be0cd4c93`.
