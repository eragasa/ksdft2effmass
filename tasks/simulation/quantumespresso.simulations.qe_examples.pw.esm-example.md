# QE 7.2 bundled PW ESM_example example
...
- **Schema version:** `3`
- **Task ID:** `quantumespresso.simulations.qe_examples.pw.esm-example`
- **Status:** `blocked`
- **Status detail:** Inventory-only Task for the bundled Quantum ESPRESSO 7.2 source group `PW/examples/ESM_example`. No script has been invoked by this Task. Exact source, executable, input, pseudopotential, dependency, resource, retention, and protected-execution preflights remain required.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the Quantum ESPRESSO 7.2 bundled example group `PW/examples/ESM_example` containing `PW/examples/ESM_example/run_example`, `PW/examples/ESM_example/run_example_ESM`, `PW/examples/ESM_example/run_example_FCP`, `PW/examples/ESM_example/run_example_GCSCF`.
...
- Inventory source group `PW/examples/ESM_example` and candidate script(s): `PW/examples/ESM_example/run_example`, `PW/examples/ESM_example/run_example_ESM`, `PW/examples/ESM_example/run_example_FCP`, `PW/examples/ESM_example/run_example_GCSCF`.
