# Wannier90 3.1.0 example06: Copper Fermi-surface workflow
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example06`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example06`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example06` tutorial on copper fermi-surface workflow.
...
- Inventory the exact `examples/example06` source directory: 4 files with canonical path-and-content manifest SHA-256 `077f1ef4ca53ee63eb60db5eb22990e4b6b5f6e46669c755e8fe58ab0734d513`.
