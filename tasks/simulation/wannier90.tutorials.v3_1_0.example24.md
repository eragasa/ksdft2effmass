# Wannier90 3.1.0 example24: Tellurium gyrotropic effects
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example24`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example24`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example24` tutorial on tellurium gyrotropic effects.
...
- Inventory the exact `examples/example24` source directory: 26 files with canonical path-and-content manifest SHA-256 `082b3d3585f94af1f2eeeb938bd26b0e1d647c56b90e12f2306dfcd28b795537`.
