# Wannier90 3.1.0 example22: Copper symmetry-adapted Wannier functions
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example22`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example22`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example22` tutorial on copper symmetry-adapted wannier functions.
...
- Inventory the exact `examples/example22` source directory: 14 files with canonical path-and-content manifest SHA-256 `76b0f317789f084a36cc34741b5469bcdb9d23374ba3f19ad977285f551a7935`.
