# Wannier90 3.1.0 example03: Silicon valence-plus-conduction interpolation
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example03`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example03`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example03` tutorial on silicon valence-plus-conduction interpolation.
...
- Inventory the exact `examples/example03` source directory: 4 files with canonical path-and-content manifest SHA-256 `72a4565368e03740e4b6ad9b561b38fda2a9718b79eade30817f25d14a124e2a`.
