# Wannier90 3.1.0 example21: Gallium arsenide symmetry-adapted Wannier functions
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example21`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example21`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example21` tutorial on gallium arsenide symmetry-adapted wannier functions.
...
- Inventory the exact `examples/example21` source directory: 21 files with canonical path-and-content manifest SHA-256 `38d7f756a3f7cdbeb7c8bc85bf638f25f8023db05624bf5d63ea04679eda3bc4`.
