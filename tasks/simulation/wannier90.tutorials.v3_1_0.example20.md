# Wannier90 3.1.0 example20: Lanthanum vanadate regional disentanglement
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example20`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example20`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example20` tutorial on lanthanum vanadate regional disentanglement.
...
- Inventory the exact `examples/example20` source directory: 12 files with canonical path-and-content manifest SHA-256 `adfc3137d649d3c33ff64dbba03b86c237c3f0bda944b8756d060c0abf84a30f`.
