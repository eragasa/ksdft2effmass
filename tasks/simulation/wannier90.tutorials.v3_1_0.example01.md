# Wannier90 3.1.0 example01: Gallium arsenide valence bands
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example01`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example01`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example01` tutorial on gallium arsenide valence bands.
...
- Inventory the exact `examples/example01` source directory: 11 files with canonical path-and-content manifest SHA-256 `c0151bb5bc13fcecf4267cd96917faec527c53cffdb797ae0a344a15387a7823`.
