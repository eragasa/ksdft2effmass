# Wannier90 3.1.0 example31: Platinum spinor SCDM localization
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example31`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example31`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example31` tutorial on platinum spinor scdm localization.
...
- Inventory the exact `examples/example31` source directory: 4 files with canonical path-and-content manifest SHA-256 `8e30b41ce52e39f7f8fa80c047acd2e968c41675f38dfaefe408e442f2c6bf8a`.
