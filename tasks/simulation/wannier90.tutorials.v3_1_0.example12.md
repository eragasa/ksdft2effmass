# Wannier90 3.1.0 example12: Benzene gamma-only workflow
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example12`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example12`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example12` tutorial on benzene gamma-only workflow.
...
- Inventory the exact `examples/example12` source directory: 4 files with canonical path-and-content manifest SHA-256 `3d8da71e3ecfc2715d11d81f0a495bb08ff7bd05963d582bb1b47e19422fe99c`.
