# Wannier90 3.1.0 example04: Copper Fermi-surface interpolation
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example04`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example04`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example04` tutorial on copper fermi-surface interpolation.
...
- Inventory the exact `examples/example04` source directory: 4 files with canonical path-and-content manifest SHA-256 `b39c47a4b6ba9aeeead576f29f6f05ac52938c7ff7588fa68e060b581c1e94a8`.
