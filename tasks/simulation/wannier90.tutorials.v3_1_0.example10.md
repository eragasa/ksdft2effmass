# Wannier90 3.1.0 example10: Graphite
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example10`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example10`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example10` tutorial on graphite.
...
- Inventory the exact `examples/example10` source directory: 4 files with canonical path-and-content manifest SHA-256 `30691233a8125200e86b4f214949525c7526ee4033843cbee2d6bb529ca083fe`.
