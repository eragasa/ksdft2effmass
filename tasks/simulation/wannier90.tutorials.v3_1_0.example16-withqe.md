# Wannier90 3.1.0 example16-withqe: Silicon BoltzWann with Quantum ESPRESSO
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example16-withqe`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example16-withqe`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example16-withqe` tutorial on silicon boltzwann with quantum espresso.
...
- Inventory the exact `examples/example16-withqe` source directory: 4 files with canonical path-and-content manifest SHA-256 `9775f60b6036df7e841e2a0997467db6350b8c8bf23cb16356b21372ab9fd17c`.
