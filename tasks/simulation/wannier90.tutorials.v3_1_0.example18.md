# Wannier90 3.1.0 example18: Iron Berry curvature and anomalous Hall conductivity
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example18`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example18`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example18` tutorial on iron berry curvature and anomalous hall conductivity.
...
- Inventory the exact `examples/example18` source directory: 4 files with canonical path-and-content manifest SHA-256 `760ac070fce3feb839dc1849e1904a9265bf275dad261a0cf71896e79ed4a3aa`.
