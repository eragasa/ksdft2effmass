# Wannier90 3.1.0 example28: Diamond Wannier-function plotting
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example28`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example28`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example28` tutorial on diamond wannier-function plotting.
...
- Inventory the exact `examples/example28` source directory: 4 files with canonical path-and-content manifest SHA-256 `e9ac6f9ad647655af49a8eca1c7011bf4364f6ccb1ed984b81d20204ca120a34`.
