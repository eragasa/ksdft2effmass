# Wannier90 3.1.0 example25: Gallium arsenide nonlinear shift current
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example25`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example25`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example25` tutorial on gallium arsenide nonlinear shift current.
...
- Inventory the exact `examples/example25` source directory: 4 files with canonical path-and-content manifest SHA-256 `1cc3dc41a9862fb19ec6263ba9f8d474f55e81fbe1ade148f772e2ac3fdbe311`.
