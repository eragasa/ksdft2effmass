# Wannier90 3.1.0 example17: Iron spin-orbit bands and Fermi contours
...
- **Schema version:** `3`
- **Task ID:** `wannier90.tutorials.v3_1_0.example17`
- **Status:** `deferred`
- **Status detail:** Deliberately deferred inventory Task for Wannier90 3.1.0 `examples/example17`. It is not selected for execution; no workspace has been created and no command has been invoked by this Task.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the bundled Wannier90 3.1.0 `examples/example17` tutorial on iron spin-orbit bands and fermi contours.
...
- Inventory the exact `examples/example17` source directory: 7 files with canonical path-and-content manifest SHA-256 `062bd5898524a50df006ad1f13b4870ac721915697557b756b21e80c7a7f67db`.
