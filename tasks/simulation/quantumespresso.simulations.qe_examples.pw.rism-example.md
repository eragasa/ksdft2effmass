# QE 7.2 bundled PW RISM_example example
...
- **Schema version:** `3`
- **Task ID:** `quantumespresso.simulations.qe_examples.pw.rism-example`
- **Status:** `blocked`
- **Status detail:** Inventory-only Task for the bundled Quantum ESPRESSO 7.2 source group `PW/examples/RISM_example`. No script has been invoked by this Task. Exact source, executable, input, pseudopotential, dependency, resource, retention, and protected-execution preflights remain required.
...
Preflight and, only after exact protected-execution authorization, execute or deliberately defer the Quantum ESPRESSO 7.2 bundled example group `PW/examples/RISM_example` containing `PW/examples/RISM_example/run_example`, `PW/examples/RISM_example/run_example_3D-RISM`, `PW/examples/RISM_example/run_example_ESM-RISM`.
...
- Inventory source group `PW/examples/RISM_example` and candidate script(s): `PW/examples/RISM_example/run_example`, `PW/examples/RISM_example/run_example_3D-RISM`, `PW/examples/RISM_example/run_example_ESM-RISM`.
