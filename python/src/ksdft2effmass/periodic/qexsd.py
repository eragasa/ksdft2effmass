...
``ParseQexsdDocument`` recognizes only the observed QEXSD 23.03.10 root and
...
class ParseQexsdDocument:
    ...
    the mechanical transformation ``QexsdSource -> QexsdDocument``.  It does not
