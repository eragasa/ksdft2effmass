...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(object(), id="sv_b_007_arbitrary_object"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(object(), id="sv_b_009_arbitrary_object_label"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(object(), id="sv_b_012_arbitrary_object"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(object(), id="sv_b_014_arbitrary_object"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(None, id="none"),
        pytest.param(object(), id="sv_b_016_arbitrary_object"),
    ],
)
