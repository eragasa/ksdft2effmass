...
def test_constructor__requires_exact_compatibility_result_type__is_enforced() -> None:
    ...
    Method
    Construct valid baseline instances, change only the named requires exact
...
def test_constructor__requires_compatible_audit_result__is_enforced() -> None:
    ...
    and energy_unit, and rejects unrelated types.
    Method
    Construct valid baseline instances, change only the named requires compatible audit
...
def test_constructor__requires_nonempty_builtin_energy_unit__is_enforced(
    ...
    and energy_unit, and rejects unrelated types.
    Method
    Construct valid baseline instances, change only the named requires nonempty builtin
    ...
    expected result.
    Acceptance
    The named partition raises exactly error with the asserted public message, code, or
...
def test_constructor__requires_matrix_intrinsic_invariants__is_enforced(
    ...
    and energy_unit, and rejects unrelated types.
    Method
    Construct valid baseline instances, change only the named requires matrix intrinsic
...
def test_field__rejects_numpy_matrix_subclass__is_exact() -> None:
    ...
    SV-ORDR-008
    Requirement
    OperatorRecordDifferenceResult enforces this represented-data partition: rejects
    numpy matrix subclass: is exact.
    Method
    Construct valid baseline instances, change only the named rejects numpy matrix
...
def test_constructor__input_boundary__rejects_numpy_memmap(tmp_path: Path) -> None:
    ...
    SV-ORDR-009
    Requirement
    OperatorRecordDifferenceResult enforces this represented-data partition: input
    boundary: rejects numpy memmap.
    Method
    Construct valid baseline instances, change only the named input boundary: rejects
