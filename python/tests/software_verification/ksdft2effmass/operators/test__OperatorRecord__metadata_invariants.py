...
class TestOperatorRecord:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(_ArbitraryInput(), id="sv_or_018_arbitrary_object"),
        ],
    )
    @staticmethod
    def test_constructor__invalid_identifier_wrong_types_are_rejected__is_enforced(
        ...
        Method: Keep every other field valid and use ``_InvalidInput`` only at the
        invalid public
        boundary.

        Oracle: The approved field contract and wrong-type taxonomy require
        ``TypeError``.
        ...
        with pytest.raises(TypeError) as exc_info:
            OperatorRecordFixtureFactory.make_record(identifier=invalid_identifier)  # type: ignore[arg-type]
    ...
    def test_constructor__empty_identifier_is_rejected__is_enforced() -> None:
        ...
        Requirement: Record identifier is nonempty and is not normalized before
        validation.
        ...
        Limitations: It does not add vocabulary policy or establish scientific
        validation,
        UQ, or Rust
        conformance.
        """
        ...
        with pytest.raises(ValueError) as exc_info:
            OperatorRecordFixtureFactory.make_record(identifier="")
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(_ArbitraryInput(), id="sv_or_020_arbitrary_object"),
        ],
    )
    @staticmethod
    def test_constructor__invalid_operator_kind_wrong_types_are__is_enforced(
        ...
        Requirement: ``operator_kind`` is a Python string and is not created by
        coercion.
        ...
        with pytest.raises(TypeError) as exc_info:
            OperatorRecordFixtureFactory.make_record(operator_kind=invalid_kind)  # type: ignore[arg-type]
    ...
    def test_constructor__empty_operator_kind_is_rejected__is_enforced() -> None:
        ...
        Requirement: Operator-kind metadata is nonempty and remains an open exact
        string.
        ...
        Limitations: It adds no enumeration and establishes no scientific validation,
        UQ, or
        Rust
        conformance.
        """
        ...
        with pytest.raises(ValueError) as exc_info:
            OperatorRecordFixtureFactory.make_record(operator_kind="")
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(_ArbitraryInput(), id="sv_or_022_arbitrary_object"),
        ],
    )
    @staticmethod
    def test_constructor__invalid_state_space_objects_are_rejected__is_enforced(
        invalid_dependency: _InvalidInput,
    ) -> None:
        r"""Evidence ID: SV-OR-022

        Requirement: ``state_space`` is a validated public StateSpace, not duck-typed
        state.

        Method: Replace only that dependency using ``_InvalidInput`` at the invalid
        boundary.
        ...
        Limitations: StateSpace intrinsic invariants, scientific validation, UQ, and
        Rust
        conformance are
        outside this evidence.
        """

        valid = OperatorRecordFixtureFactory.make_record()
        with pytest.raises(TypeError) as exc_info:
            OperatorRecord(
                valid.identifier,
                valid.operator_kind,
                valid.matrix,
                invalid_dependency,  # type: ignore[arg-type]
                valid.basis,
                valid.geometry,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(_ArbitraryInput(), id="sv_or_023_arbitrary_object"),
        ],
    )
    @staticmethod
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(_ArbitraryInput(), id="sv_or_024_arbitrary_object"),
        ],
    )
    @staticmethod
    def test_constructor__invalid_geometry_objects_are_rejected__is_enforced(
        ...
        Requirement: ``geometry`` is a validated public Geometry, not duck-typed
        metadata.
        ...
        Limitations: Geometry intrinsic/numerical evidence, scientific validation, UQ,
        and
        Rust
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(_ArbitraryInput(), id="sv_or_025_arbitrary_object"),
        ],
    )
    @staticmethod
    def test_constructor__invalid_energy_reference_objects_are__is_enforced(
        ...
        Limitations: EnergyReference intrinsic invariants, scientific validation, UQ,
        and
        Rust
        conformance are outside this evidence.
        """
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(_ArbitraryInput(), id="sv_or_026_arbitrary_object"),
        ],
    )
    @staticmethod
    def test_constructor__invalid_provenance_containers_are_rejected__is_enforced(
        invalid_provenance: _InvalidInput,
    ) -> None:
        r"""Evidence ID: SV-OR-026

        Requirement: Provenance is a ``Mapping``; iterable pairs and other containers
        are
        not silently
        passed through ``dict()``.
        ...
        Limitations: Mapping contents are separate evidence; no scientific validation,
        UQ,
        or Rust
        ...
        with pytest.raises(TypeError) as exc_info:
            OperatorRecordFixtureFactory.make_record(provenance=invalid_provenance)  # type: ignore[arg-type]
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(b"source", id="bytes"),
            pytest.param(None, id="none"),
            pytest.param(_ArbitraryInput(), id="sv_or_027_arbitrary_object"),
        ],
    )
    @staticmethod
    def test_constructor__invalid_provenance_key_types_are_rejected__is_enforced(
        invalid_key: _InvalidInput,
    ) -> None:
        ...
        Limitations: It does not validate provenance truth, scientific validation, UQ,
        or
        Rust
        conformance.
        """

        provenance = {invalid_key: "test"}
        with pytest.raises(TypeError) as exc_info:
            OperatorRecordFixtureFactory.make_record(provenance=provenance)  # type: ignore[arg-type]
        message = str(exc_info.value)
        assert "provenance" in message
    ...
    def test_constructor__empty_provenance_key_is_rejected__is_enforced() -> None:
        ...
        Limitations: It establishes no provenance truth, scientific validation, UQ, or
        Rust
        conformance.
        """

        with pytest.raises(ValueError) as exc_info:
            OperatorRecordFixtureFactory.make_record(provenance={"": "test"})
        message = str(exc_info.value)
        assert "provenance" in message
        assert "must not be empty" in message
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(None, id="none"),
            pytest.param(_ArbitraryInput(), id="sv_or_029_arbitrary_object"),
        ],
    )
    @staticmethod
    def test_constructor__invalid_provenance_value_types_are_rejected__is_enforced(
        invalid_value: _InvalidInput,
    ) -> None:
        ...
        provenance = {"source": invalid_value}
        with pytest.raises(TypeError) as exc_info:
            OperatorRecordFixtureFactory.make_record(provenance=provenance)  # type: ignore[arg-type]
        message = str(exc_info.value)
        assert "provenance" in message
    ...
    def test_constructor__empty_provenance_value_is_rejected__is_enforced() -> None:
        ...
        with pytest.raises(ValueError) as exc_info:
            OperatorRecordFixtureFactory.make_record(provenance={"source": ""})
        message = str(exc_info.value)
        assert "provenance" in message
        assert "must not be empty" in message
    ...
    def test_constructor__explicit_empty_provenance_mapping_is__is_enforced() -> None:
        ...
        Method: Supply ``{}`` explicitly through a helper that distinguishes ``None``
        from
        empty
        ...
        Limitations: Absence of provenance does not establish reproducibility,
        scientific
        validation, UQ,
        or Rust conformance.
        """
