...
class TestQePwInputFileWriter:
    """Own this module's maintained software-verification evidence."""

    def test_method__execute__writes_namelists_cards_and_unknown_groups(self) -> None:
    ...
    def test_method__execute__writes_empty_input_as_empty_text(self) -> None:
    ...
    def test_method__execute__rejects_wrong_semantic_type(self) -> None:
