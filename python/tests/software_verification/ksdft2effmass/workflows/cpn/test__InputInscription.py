...
def test_constructor__input_inscription__preserves_valid_state() -> None:
    ...
    Requirement
    -----------
    ``InputInscription`` preserves the documented exact valid-state behavior for its
...
def test_constructor__input_inscription__rejects_wrong_types() -> None:
    ...
    Requirement
    -----------
    ``InputInscription`` rejects wrong semantic types for its ``input_inscription``
    contract.
...
def test_constructor__input_inscription__rejects_invalid_values() -> None:
    ...
    Requirement
    -----------
    ``InputInscription`` rejects malformed values of accepted semantic
    types for its
    ``input_inscription`` contract.
