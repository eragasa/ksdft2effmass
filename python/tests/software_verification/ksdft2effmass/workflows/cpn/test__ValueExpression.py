...
def test_constructor__expression_union__preserves_valid_state() -> None:
    ...
    Requirement
    -----------
    ``ValueExpression`` preserves the documented exact valid-state behavior for its
...
def test_constructor__expression_union__rejects_wrong_types() -> None:
    ...
    Requirement
    -----------
    ``ValueExpression`` rejects wrong semantic types for its ``expression_union``
    contract.
...
def test_constructor__expression_union__rejects_invalid_values() -> None:
    ...
    Requirement
    -----------
    ``ValueExpression`` rejects malformed values of accepted semantic
    types for its
    ``expression_union`` contract.
...
def test_constructor__expression_fields__rejects_wrong_types() -> None:
    ...
    Requirement
    -----------
    ``ValueExpression`` rejects wrong semantic types at the public
