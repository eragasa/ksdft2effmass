...
def test_method__execute__complete_net_mapping_validates(
    ...
    """Evidence ID: SV-CPN-011

    Requirement: complete executable representation of the CPN tuple.
    ...
    Oracle: The documented public rule that the SUT must complete executable
    representation of
