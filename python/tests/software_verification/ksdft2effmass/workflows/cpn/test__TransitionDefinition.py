...
def test_constructor__transition_requires__preserves_valid_state() -> None:
    ...
    Requirement
    -----------
    ``TransitionDefinition`` preserves the documented exact valid-state behavior for
...
def test_constructor__transition_requires__rejects_wrong_types() -> None:
    ...
    Requirement
    -----------
    ``TransitionDefinition`` rejects wrong semantic types for its
...
def test_constructor__transition_requires__rejects_invalid_values() -> None:
    ...
    Requirement
    -----------
    ``TransitionDefinition`` rejects malformed values of accepted semantic
    types for its
    ``transition_requires`` contract.
