...
def test_constructor__pattern_requires__preserves_valid_state() -> None:
    ...
    Requirement
    -----------
    ``TokenPattern`` preserves the documented exact valid-state behavior for its
...
def test_constructor__pattern_requires__rejects_wrong_types() -> None:
    ...
    Requirement
    -----------
    ``TokenPattern`` rejects wrong semantic types for its ``pattern_requires`` contract.
...
def test_constructor__pattern_requires__rejects_invalid_values() -> None:
    ...
    Requirement
    -----------
    ``TokenPattern`` rejects malformed values of accepted semantic
    types for its
    ``pattern_requires`` contract.
