...
def test_constructor__transition_binding__preserves_valid_state() -> None:
    ...
    Requirement
    -----------
    ``TransitionBinding`` preserves the documented exact valid-state behavior for
...
def test_constructor__transition_binding__rejects_wrong_types() -> None:
    ...
    Requirement
    -----------
    ``TransitionBinding`` rejects wrong semantic types for its
...
def test_constructor__transition_binding__rejects_invalid_values() -> None:
    ...
    Requirement
    -----------
    ``TransitionBinding`` rejects malformed values of accepted semantic
    types for its
    ``transition_binding`` contract.
