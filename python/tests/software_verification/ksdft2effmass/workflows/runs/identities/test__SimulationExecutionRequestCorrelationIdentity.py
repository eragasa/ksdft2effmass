r"""Software verification of ``SimulationExecutionRequestCorrelationIdentity``.

Evidence profile: routine

Bounded artifact scope: the public ``SimulationExecutionRequestCorrelationIdentity``
contract.
...
from ksdft2effmass.workflows.runs import SimulationExecutionRequestCorrelationIdentity

pytestmark = pytest.mark.software_verification
SUT = SimulationExecutionRequestCorrelationIdentity


class TestSimulationExecutionRequestCorrelationIdentity:
    """Own software evidence for ``SimulationExecutionRequestCorrelationIdentity``."""
    ...
    def test_constructor__value__requires_nonempty_exact_text(self) -> None:
        ...
        Evidence ID: SV-WFR-SIMULATION-EXECUTION-REQUEST-CORRELATION-IDENTITY-001

        Requirement: ``SimulationExecutionRequestCorrelationIdentity`` wraps one
