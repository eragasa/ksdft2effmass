r"""Software verification of ``WorkflowDefinitionReferenceIdentity``.

Evidence profile: routine

Bounded artifact scope: the public ``WorkflowDefinitionReferenceIdentity`` contract.
...
from ksdft2effmass.workflows.runs import WorkflowDefinitionReferenceIdentity

pytestmark = pytest.mark.software_verification
SUT = WorkflowDefinitionReferenceIdentity


class TestWorkflowDefinitionReferenceIdentity:
    """Own software evidence for ``WorkflowDefinitionReferenceIdentity``."""
    ...
    def test_constructor__value__requires_nonempty_exact_text(self) -> None:
        ...
        Evidence ID: SV-WFR-WORKFLOW-DEFINITION-REFERENCE-IDENTITY-001

        Requirement: ``WorkflowDefinitionReferenceIdentity`` wraps one nonempty
