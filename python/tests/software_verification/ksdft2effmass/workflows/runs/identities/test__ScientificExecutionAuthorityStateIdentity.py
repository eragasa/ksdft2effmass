r"""Software verification of ``ScientificExecutionAuthorityStateIdentity``.

Evidence profile: routine

Bounded artifact scope: the public ``ScientificExecutionAuthorityStateIdentity``
contract.
...
from ksdft2effmass.workflows.runs import ScientificExecutionAuthorityStateIdentity

pytestmark = pytest.mark.software_verification
SUT = ScientificExecutionAuthorityStateIdentity


class TestScientificExecutionAuthorityStateIdentity:
    """Own software evidence for ``ScientificExecutionAuthorityStateIdentity``."""
    ...
    def test_constructor__value__requires_nonempty_exact_text(self) -> None:
        ...
        Evidence ID: SV-WFR-SCIENTIFIC-EXECUTION-AUTHORITY-STATE-IDENTITY-001

        Requirement: ``ScientificExecutionAuthorityStateIdentity`` wraps one
