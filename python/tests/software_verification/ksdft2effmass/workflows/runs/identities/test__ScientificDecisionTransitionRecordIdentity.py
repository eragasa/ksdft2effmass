r"""Software verification of ``ScientificDecisionTransitionRecordIdentity``.

Evidence profile: routine

Bounded artifact scope: the public ``ScientificDecisionTransitionRecordIdentity``
contract.
...
from ksdft2effmass.workflows.runs import ScientificDecisionTransitionRecordIdentity

pytestmark = pytest.mark.software_verification
SUT = ScientificDecisionTransitionRecordIdentity


class TestScientificDecisionTransitionRecordIdentity:
    """Own software evidence for ``ScientificDecisionTransitionRecordIdentity``."""
    ...
    def test_constructor__value__requires_nonempty_exact_text(self) -> None:
        ...
        Evidence ID: SV-WFR-SCIENTIFIC-DECISION-TRANSITION-RECORD-IDENTITY-001

        Requirement: ``ScientificDecisionTransitionRecordIdentity`` wraps one
