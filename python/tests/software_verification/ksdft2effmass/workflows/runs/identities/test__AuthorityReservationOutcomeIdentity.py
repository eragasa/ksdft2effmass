r"""Software verification of ``AuthorityReservationOutcomeIdentity``.

Evidence profile: routine

Bounded artifact scope: the public ``AuthorityReservationOutcomeIdentity`` contract.
...
from ksdft2effmass.workflows.runs import AuthorityReservationOutcomeIdentity

pytestmark = pytest.mark.software_verification
SUT = AuthorityReservationOutcomeIdentity


class TestAuthorityReservationOutcomeIdentity:
    """Own software evidence for ``AuthorityReservationOutcomeIdentity``."""
    ...
    def test_constructor__value__requires_nonempty_exact_text(self) -> None:
        ...
        Evidence ID: SV-WFR-AUTHORITY-RESERVATION-OUTCOME-IDENTITY-001

        Requirement: ``AuthorityReservationOutcomeIdentity`` wraps one nonempty
