r"""Software verification of ``SimulationDispatchOutcomeIdentity``.

Evidence profile: routine

Bounded artifact scope: the public ``SimulationDispatchOutcomeIdentity`` contract.
...
from ksdft2effmass.workflows.runs import SimulationDispatchOutcomeIdentity

pytestmark = pytest.mark.software_verification
SUT = SimulationDispatchOutcomeIdentity


class TestSimulationDispatchOutcomeIdentity:
    """Own software evidence for ``SimulationDispatchOutcomeIdentity``."""
    ...
    def test_constructor__value__requires_nonempty_exact_text(self) -> None:
        ...
        Evidence ID: SV-WFR-SIMULATION-DISPATCH-OUTCOME-IDENTITY-001

        Requirement: ``SimulationDispatchOutcomeIdentity`` wraps one nonempty
