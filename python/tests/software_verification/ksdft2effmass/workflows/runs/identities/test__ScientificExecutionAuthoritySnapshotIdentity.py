r"""Software verification of ``ScientificExecutionAuthoritySnapshotIdentity``.

Evidence profile: routine

Bounded artifact scope: the public ``ScientificExecutionAuthoritySnapshotIdentity``
contract.
...
from ksdft2effmass.workflows.runs import ScientificExecutionAuthoritySnapshotIdentity

pytestmark = pytest.mark.software_verification
SUT = ScientificExecutionAuthoritySnapshotIdentity


class TestScientificExecutionAuthoritySnapshotIdentity:
    """Own software evidence for ``ScientificExecutionAuthoritySnapshotIdentity``."""
    ...
    def test_constructor__value__requires_nonempty_exact_text(self) -> None:
        ...
        Evidence ID: SV-WFR-SCIENTIFIC-EXECUTION-AUTHORITY-SNAPSHOT-IDENTITY-001

        Requirement: ``ScientificExecutionAuthoritySnapshotIdentity`` wraps one
