r"""Software verification of ``SimulationExecutionRequestIdentity``.

Evidence profile: routine

Bounded artifact scope: the public ``SimulationExecutionRequestIdentity`` contract.
...
from ksdft2effmass.workflows.runs import SimulationExecutionRequestIdentity

pytestmark = pytest.mark.software_verification
SUT = SimulationExecutionRequestIdentity


class TestSimulationExecutionRequestIdentity:
    """Own software evidence for ``SimulationExecutionRequestIdentity``."""
    ...
    def test_constructor__value__requires_nonempty_exact_text(self) -> None:
        ...
        Evidence ID: SV-WFR-SIMULATION-EXECUTION-REQUEST-IDENTITY-001

        Requirement: ``SimulationExecutionRequestIdentity`` wraps one nonempty
