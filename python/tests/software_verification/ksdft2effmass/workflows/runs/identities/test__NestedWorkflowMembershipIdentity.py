r"""Software verification of ``NestedWorkflowMembershipIdentity``.

Evidence profile: routine

Bounded artifact scope: the public ``NestedWorkflowMembershipIdentity`` contract.
...
from ksdft2effmass.workflows.runs import NestedWorkflowMembershipIdentity

pytestmark = pytest.mark.software_verification
SUT = NestedWorkflowMembershipIdentity


class TestNestedWorkflowMembershipIdentity:
    """Own software evidence for ``NestedWorkflowMembershipIdentity``."""
    ...
    def test_constructor__value__requires_nonempty_exact_text(self) -> None:
        ...
        Evidence ID: SV-WFR-NESTED-WORKFLOW-MEMBERSHIP-IDENTITY-001

        Requirement: ``NestedWorkflowMembershipIdentity`` wraps one nonempty
