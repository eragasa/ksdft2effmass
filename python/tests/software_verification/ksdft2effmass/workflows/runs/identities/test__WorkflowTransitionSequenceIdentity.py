r"""Software verification of ``WorkflowTransitionSequenceIdentity``.

Evidence profile: routine

Bounded artifact scope: the public ``WorkflowTransitionSequenceIdentity`` contract.
...
from ksdft2effmass.workflows.runs import WorkflowTransitionSequenceIdentity

pytestmark = pytest.mark.software_verification
SUT = WorkflowTransitionSequenceIdentity


class TestWorkflowTransitionSequenceIdentity:
    """Own software evidence for ``WorkflowTransitionSequenceIdentity``."""
    ...
    def test_constructor__value__requires_nonempty_exact_text(self) -> None:
        ...
        Evidence ID: SV-WFR-WORKFLOW-TRANSITION-SEQUENCE-IDENTITY-001

        Requirement: ``WorkflowTransitionSequenceIdentity`` wraps one nonempty
