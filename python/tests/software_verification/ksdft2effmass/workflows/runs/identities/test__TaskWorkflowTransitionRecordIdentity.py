r"""Software verification of ``TaskWorkflowTransitionRecordIdentity``.

Evidence profile: routine

Bounded artifact scope: the public ``TaskWorkflowTransitionRecordIdentity`` contract.
...
from ksdft2effmass.workflows.runs import TaskWorkflowTransitionRecordIdentity

pytestmark = pytest.mark.software_verification
SUT = TaskWorkflowTransitionRecordIdentity


class TestTaskWorkflowTransitionRecordIdentity:
    """Own software evidence for ``TaskWorkflowTransitionRecordIdentity``."""
    ...
    def test_constructor__value__requires_nonempty_exact_text(self) -> None:
        ...
        Evidence ID: SV-WFR-TASK-WORKFLOW-TRANSITION-RECORD-IDENTITY-001

        Requirement: ``TaskWorkflowTransitionRecordIdentity`` wraps one nonempty
