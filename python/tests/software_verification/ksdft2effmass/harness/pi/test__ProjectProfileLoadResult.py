...
from ksdft2effmass.harness.pi import ProjectProfileLoadResult

pytestmark = pytest.mark.software_verification
SUT = ProjectProfileLoadResult


def test_constructor__failed_primary_values__are_rejected() -> None:
    """Evidence ID: SV-HARNESS-017

    Requirement: ProjectProfileLoadResult enforces the H1 failed-result no-partial-value
    invariant.
