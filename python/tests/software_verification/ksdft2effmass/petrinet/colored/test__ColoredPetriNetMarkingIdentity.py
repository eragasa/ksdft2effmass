r"""Software verification of ``ColoredPetriNetMarkingIdentity``.
...
from ksdft2effmass.petrinet.colored import ColoredPetriNetMarkingIdentity

pytestmark = pytest.mark.software_verification
SUT = ColoredPetriNetMarkingIdentity


def test_constructor__identity_value__enforces_exact_lexical_boundary() -> None:
    """Evidence ID: SV-PETRINET-071
