r"""Software verification of ``ColoredPetriNetBindingVariableIdentity``.
...
from ksdft2effmass.petrinet.colored import ColoredPetriNetBindingVariableIdentity

pytestmark = pytest.mark.software_verification
SUT = ColoredPetriNetBindingVariableIdentity


def test_constructor__identity_value__enforces_exact_lexical_boundary() -> None:
    """Evidence ID: SV-PETRINET-074
