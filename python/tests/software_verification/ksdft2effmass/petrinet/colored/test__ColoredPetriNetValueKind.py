r"""Software verification of ``ColoredPetriNetValueKind``.
...
from ksdft2effmass.petrinet.colored import ColoredPetriNetValueKind

pytestmark = pytest.mark.software_verification
SUT = ColoredPetriNetValueKind


def test_property__members__matches_exact_values() -> None:
    """Evidence ID: SV-PETRINET-076
