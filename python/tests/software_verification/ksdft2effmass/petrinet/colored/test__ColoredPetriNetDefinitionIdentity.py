r"""Software verification of ``ColoredPetriNetDefinitionIdentity``.
...
from ksdft2effmass.petrinet.colored import ColoredPetriNetDefinitionIdentity

pytestmark = pytest.mark.software_verification
SUT = ColoredPetriNetDefinitionIdentity


def test_constructor__identity_value__enforces_exact_lexical_boundary() -> None:
    """Evidence ID: SV-PETRINET-024
