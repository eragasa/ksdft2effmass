r"""Software verification of ``ColoredPetriNetArcIdentity``.
...
from ksdft2effmass.petrinet.colored import ColoredPetriNetArcIdentity

pytestmark = pytest.mark.software_verification
SUT = ColoredPetriNetArcIdentity


def test_constructor__identity_value__enforces_exact_lexical_boundary() -> None:
    """Evidence ID: SV-PETRINET-075
