...
class TestAlignedBandComparisonProbe:
    ...
    def make_specification() -> BandComparisonSpecification:
        ...
        Limitations: The large synthetic tolerance is test policy, not scientific
        policy.
        """
    ...
    def test_artifact__maximum_difference__agrees_with_exact_synthetic_oracle(
        self,
    ) -> None:
