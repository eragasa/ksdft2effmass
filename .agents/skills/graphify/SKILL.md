...
When operating in the `ksdft2effmass` repository, first read and obey
`references/ksdft2effmass-policy.md`. That file is a versioned local policy
overlay; it preserves upstream Graphify provenance and version `0.9.2` while
