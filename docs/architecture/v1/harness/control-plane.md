...
The maintained control CLI exposes synchronization and checking. Synchronization requires explicit canonical evidence and resource inputs and publishes a complete projection set. Checking reconstructs the candidate read-only and reports drift.
