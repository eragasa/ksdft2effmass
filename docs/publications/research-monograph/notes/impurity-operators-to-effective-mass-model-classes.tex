\notechapter{7}{From Kohn--Sham impurity operators to effective-mass model classes}

\textbf{Status: synthesis and proposed research program.} This note defines a
...
energy-reference conventions. This note chooses the pristine retained space as the reference and defines
\begin{equation}
...
\begin{equation}
    ...
    \hat U_d^\dagger.
\end{equation}
The direction must remain explicit. In the remainder of this note,
...
a conventional slowly varying local approximation~\cite{ermoneit2026}. This
provides a direct precedent for treating locality as a model-class hypothesis.
