\notechapter{6}{Two-dimensional separable-to-coupled periodic Wannier warmup}
...
described in this note has yet been produced. The experiment is intended to
...
\begin{equation}
    ...
    \frac{1}{2\pi}
    \int_{\mathrm{BZ}}
    \operatorname{Tr}\mathbf\Omega(\mathbf k)\,d^2k,
\end{equation}
where $\mathbf\Omega$ is the Berry-curvature matrix of the retained subspace.
...
This note does not propose introducing magnetic phases or a Chern-band model in
