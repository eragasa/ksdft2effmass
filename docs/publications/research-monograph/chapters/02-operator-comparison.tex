...
Gauge covariance of the complete represented operator does not imply gauge
invariance after real-space truncation. Two gauges can represent the same
pointwise spectrum and projector while producing different hopping decay and
therefore different finite-range residuals. Appendix~\ref{app:one-dimensional-reduction}
demonstrates this distinction with controlled smooth and rough composite-band
frames.
