...
parent are frozen prerequisites for the proposed two-dimensional defect
extension in Appendix~\ref{app:two-dimensional-defect-extraction}. That
extension remains inactive and should test only genuinely two-dimensional
defect structure rather than repeat the completed prerequisites. Material
transfer follows only after that separate controlled stage and its own
authorization.
