...
conventions. Research notes own declared scientific assumptions, computational
...
Statements about future work are proposals rather than results. A typeset
formula is not by itself a proof, a successful software test is not scientific
validation, and a generated figure is not a calculated result unless its input,
