...
The project maintains a proof workspace under
\path{docs/proofs/ksdft2effmass/} and prover-neutral contracts under
\path{formal/theorem-catalog/}. Those records own proof decomposition and
