...
proposed two-dimensional defect and material-transfer sequence. It consumes the
accepted periodic parent and spin-space and one-dimensional extraction
contracts, but it contains no completed two-dimensional defect calculation and
