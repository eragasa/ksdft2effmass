...
\section{Controlled periodic-reduction benchmark}
\index{evidence!periodic reduction benchmark}

\evidenceclass{calculated illustrative numerical verification; final human
...
verification checks, but final human acceptance of the periodic-reduction task
remains pending.
