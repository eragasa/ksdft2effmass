\chapter{Operator Spaces, Compression, and Alignment}
\index{operator space|textbf}
\index{compression|textbf}

\label{app:operator-spaces}
...
\citationtodo{low priority}{Complete the compound Feshbach--Lowdin attribution.
The existing \texttt{lowdin1982} supports the Lowdin side; check and add the
already-present primary key \texttt{feshbach1958} at this occurrence if its
scope matches the displayed construction.}
...
\index{compression!common additive}
