...
at the inclusive $10^{-11}$ tolerance. In the documented Python~3.14.6,
NumPy~2.5.1, and SciPy~1.18.0 environment, the largest categorized reconstruction
defects were $7.56\times10^{-15}$ for bands 0--1 and
...
cutoff error, model-reduction error, material-model error, or uncertainty. The focused
35-test periodic campaign suite, Ruff, strict mypy, warnings-as-errors Sphinx build,
and software/numerical evidence-conformance checks passed for this implementation
snapshot. Agreement with the historical result is compatibility evidence and does not
reattribute or rerun the retained calculation.
