\chapter{One-Dimensional Bloch, Wannier, and Tight-Binding Reduction}
...
convergence result, fitted model, or plot described in this appendix has yet been
...
numerical result of this appendix.
...
conversion. Agreement with one library or table is not assumed by this appendix.
...
\citationtodo{medium priority}{Check the Mathieu transformation, Floquet
condition, and use of characteristic values as an independent band reference
against a standard Mathieu-function source. Candidate: McLachlan (1947),
provisional key \texttt{mclachlan1947}; the candidate record is present for this
editorial note.}
...
\index{Wannier localization!one-dimensional}
...
\index{tight-binding model!finite range}
