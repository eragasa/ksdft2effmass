...
\index{Hilbert--Schmidt geometry|textbf}
\index{Frobenius norm|textbf}

\label{app:hilbert-schmidt-and-frobenius}

\chapterstatus{expository appendix. This appendix records the operator-space geometry
...
\index{operator difference!aligned pristine--doped}
...
\citationtodo{medium priority}{Check the operator-domain and self-adjoint
realization distinction against a standard Schrodinger-operator source.
Candidate: Teschl (2014), bibliography key \texttt{teschl2014} (already
present).}
...
\index{infinite-dimensional qualification}
...
\citationtodo{medium priority}{Check the infinite-dimensional Hilbert--Schmidt
class qualification and the finite-rank inclusion against Simon (2005),
bibliography key \texttt{simon2005} (already present).}
