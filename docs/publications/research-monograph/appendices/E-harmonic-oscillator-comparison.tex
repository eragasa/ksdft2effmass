...
\chapterstatus{proposed preliminary experiment. The comparison, convergence
study, and plots described in this appendix have not yet been carried out. No
...
\begin{enumerate}
    ...
    \item \textbf{Placeholder---diagonal and off-diagonal decomposition.}
          ...
          $b$ and $\eta$.
    \item \textbf{Placeholder---operator-difference heat map.} Display, for
          selected parameter values, the entries of
          \begin{equation*}
