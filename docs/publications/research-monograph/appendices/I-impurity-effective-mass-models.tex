...
numerical-verification results, a human-accepted bounded primary-literature
comparison, and a proposed subsequent research program. The spin-space and one-dimensional
impurity calculations remain within bounded finite-model scopes.
...
The one-dimensional evidence also includes accepted blind-alignment,
independent-route, finite-rank-oracle, and continuum-refinement follow-ons. The
two-dimensional stages and material transfer remain proposed work.
