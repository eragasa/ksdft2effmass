...
resolves the unique root below the finite-host lower edge. An independent route
assembles and diagonalizes the full site-space defect operator. Inputs, source
...
first three follow-ons are human accepted; the sequence remains:
\begin{enumerate}
...
is the accepted bounded independent-route result, and the third is the accepted
bounded analytical-oracle result. Items four and five remain proposed
follow-on experiments rather than extensions of the accepted result, and none
is an active material calculation. Keeping the alignment
