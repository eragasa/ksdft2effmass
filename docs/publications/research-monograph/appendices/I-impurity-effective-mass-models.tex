...
first four follow-ons are human accepted; the sequence remains:
\begin{enumerate}
...
\end{enumerate}
The first item is the accepted blind-alignment result reported above, the second
is the accepted bounded independent-route result, the third is the accepted
bounded analytical-oracle result, and the fourth is the accepted bounded
continuum-refinement result. The fifth remains a proposed follow-on experiment
rather than an extension of the accepted result, and none is an active material
calculation. Keeping the alignment
