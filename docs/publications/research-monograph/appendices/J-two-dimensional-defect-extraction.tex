...
\chapterstatus{proposed controlled synthetic and material-transfer program. The
periodic two-dimensional parent, spin-space contracts, and one-dimensional
defect-extraction chain are completed prerequisites, but no two-dimensional
defect extraction, material impurity operator, continuum crossover, scientific
validation, or uncertainty-quantification result is claimed.}
...
model-class, analytical-oracle, and continuum-refinement contracts. The work
below adds only genuinely two-dimensional defect structure and remains proposed
until separately activated and supported by retained calculated evidence.
...
As recorded in Appendix~\ref{app:impurity-model-classes}, the first item,
items two through seven, and the bounded one-dimensional metric comparison in
item eleven have human-accepted calculated synthetic evidence. That evidence
also includes accepted blind-alignment, independent-route, finite-rank-oracle,
and continuum-refinement follow-ons. The two-dimensional stages and material
transfer remain proposed work.
