...
evidence boundary. No directional or nonlocal two-dimensional defect extraction, material impurity
...
material validation. Stages~C--E remain defined only at program level. The program adds
...
bridge, schedule, ambiguity, and adverse-control contracts only. HC08 accepts
this exact evidence boundary; it does not authorize a rerun or Stage~C.
