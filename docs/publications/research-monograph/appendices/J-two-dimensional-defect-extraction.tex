...
prerequisites, but no two-dimensional defect extraction, material impurity
operator, continuum crossover, scientific validation, or
...
controlled synthetic task is active but has no calculated result. It adds only
genuinely two-dimensional defect structure; material transfer remains proposed
and requires separate authorization and retained calculated evidence.
