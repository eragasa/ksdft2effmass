...
| Mechanized finite-dimensional lemma layer | [Mechanized-proof architecture](../../../architecture/mechanized-proof-system.md), [PRF-05 status](../../../proofs/ksdft2effmass/status/proof.05-mechanized-lemmas.md), and [theorem catalog](../../../../formal/theorem-catalog/PRF-05.md) | Nine contracts are frozen after conditional review, correction, and human confirmation; no backend encoding exists |
