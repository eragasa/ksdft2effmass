...
The project workflow is a Colored Petri Net (CPN) with typed token colors and multiset markings. See the [implemented Architecture v1 CPN description](../architecture/v1/index.md#existing-cpn-implementation) for the mathematical definition and ownership rules.
