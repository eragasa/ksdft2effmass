...
The project workflow is a Colored Petri Net (CPN) with typed token colors and multiset markings. See the [implemented Architecture v1 CPN description](../architecture/v1/ksdft2effmass/workflows/cpn/model.md) for the mathematical definition and ownership rules.
