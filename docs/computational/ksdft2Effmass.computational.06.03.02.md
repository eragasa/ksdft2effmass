...
# Task 06.03.02: Extract $\Delta\mathbf{H}_{\mathrm W,\mathrm P}$
...
Extract $\Delta\mathbf{H}_{\mathrm W,\mathrm P}$. The task produces the artifact Impurity-operator sequence required by the downstream dependency graph.

## Prerequisites

[[ksdft2Effmass.computational.06.03.01|06.03.01]].
...
- [[ksdft2Effmass.computational.06.03.03|06.03.03]]
