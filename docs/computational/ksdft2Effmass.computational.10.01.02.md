...
# Task 10.01.02: Compare direct and Wannier-mediated TB paths
...
Compare direct and Wannier-mediated TB paths. The task produces the artifact TB path-consistency record required by the downstream dependency graph.
