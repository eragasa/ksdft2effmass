...
# Task 05.02.01: Define common supercell and orbital indexing conventions
...
Define common supercell and orbital indexing conventions. The task produces the artifact Comparison-space specification required by the downstream dependency graph.
...
Comparison-space specification
