...
# Task 01.03.01: Implement common operator, subspace, spectral, and observable metrics
...
Implement common operator, subspace, spectral, and observable metrics. The task produces the artifact Metrics library required by the downstream dependency graph.

## Prerequisites

[[ksdft2Effmass.computational.01.02.01|01.02.01]].
