...
# Task 09.01.01: Extract bulk band-edge tensors and channel data
...
Extract bulk band-edge tensors and channel data. The task produces the artifact Continuum host parameters required by the downstream dependency graph.
...
- [[ksdft2Effmass.computational.09.02.01|09.02.01]]
