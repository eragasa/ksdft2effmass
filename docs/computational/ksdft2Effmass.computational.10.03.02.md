...
# Task 10.03.02: Fit or bound stagewise stability factors
...
Fit or bound stagewise stability factors. The task produces the artifact Error-propagation rule required by the downstream dependency graph.

## Prerequisites

[[ksdft2Effmass.computational.10.03.01|10.03.01]].
