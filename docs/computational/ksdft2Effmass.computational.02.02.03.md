...
# Task 02.02.03: Freeze the bulk reference dataset
...
Freeze the bulk reference dataset. The task produces the artifact BulkSiReference-v1 required by the downstream dependency graph.
...
- contributes to the completion gate for Computational Stage `02`
