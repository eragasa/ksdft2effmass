...
# Task 06.01.02: Define the phosphorus supercell sequence
...
Define the phosphorus supercell sequence. The task produces the artifact Finite-size study design required by the downstream dependency graph.

## Prerequisites

[[ksdft2Effmass.computational.06.01.01|06.01.01]], `G02`.
...
- [[ksdft2Effmass.computational.06.01.03|06.01.03]]
