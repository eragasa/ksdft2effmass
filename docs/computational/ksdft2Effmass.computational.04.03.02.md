...
# Task 04.03.02: Fit or project the Wannier-to-TB model
...
Fit or project the Wannier-to-TB model. The task produces the artifact WannierTB-v1 required by the downstream dependency graph.
