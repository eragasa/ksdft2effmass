...
# Task 03.01.01: Define the target band-edge subspace
...
Define the target band-edge subspace. The task produces the artifact Target-subspace specification required by the downstream dependency graph.
...
- [[ksdft2Effmass.computational.03.01.02|03.01.02]]
