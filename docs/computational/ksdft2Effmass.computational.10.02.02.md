...
# Task 10.02.02: Reduce parent operators before impurity extraction
...
Reduce parent operators before impurity extraction. The task produces the artifact Reduce-then-extract outputs required by the downstream dependency graph.
...
- [[ksdft2Effmass.computational.10.02.03|10.02.03]]
