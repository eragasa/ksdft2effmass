...
# Task 06.02.01: Construct P:Si Wannier operators
...
Construct P:Si Wannier operators. The task produces the artifact Doped Wannier candidates required by the downstream dependency graph.

## Prerequisites

[[ksdft2Effmass.computational.06.01.03|06.01.03]], `G03`.
...
- [[ksdft2Effmass.computational.06.02.02|06.02.02]]
