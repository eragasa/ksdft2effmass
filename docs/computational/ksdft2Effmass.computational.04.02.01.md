...
# Task 04.02.01: Define training and withheld validation sets
...
Define training and withheld validation sets. The task produces the artifact Frozen fitting datasets required by the downstream dependency graph.
