...
# Task 04.02.02: Fit the direct DFT-to-TB model
...
Fit the direct DFT-to-TB model. The task produces the artifact DirectTB-v1 required by the downstream dependency graph.

## Prerequisites

[[ksdft2Effmass.computational.04.01.02|04.01.02]], [[ksdft2Effmass.computational.04.02.01|04.02.01]].
