...
# Task 09.01.03: Implement and verify the multiband acceptor solver
...
Implement and verify the multiband acceptor solver. The task produces the artifact Acceptor continuum solver required by the downstream static prerequisite projection and CPN transition contracts.
...
- [[ksdft2Effmass.computational.09.01.04|09.01.04]]
