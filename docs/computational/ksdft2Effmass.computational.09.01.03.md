...
Implement and verify the multiband acceptor solver. The task produces the artifact Acceptor continuum solver required by the downstream dependency graph.
