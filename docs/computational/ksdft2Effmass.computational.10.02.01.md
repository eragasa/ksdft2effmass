...
# Task 10.02.01: Reduce extracted impurity operators
...
Reduce extracted impurity operators. The task produces the artifact Extract-then-reduce outputs required by the downstream dependency graph.
