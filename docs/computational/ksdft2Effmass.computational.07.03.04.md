...
# Task 07.03.04: Freeze the boron impurity operator
...
Freeze the boron impurity operator. The task produces the artifact BImpurityOperator-v1 required by the downstream dependency graph.

## Prerequisites

[[ksdft2Effmass.computational.07.03.03|07.03.03]].
...
- contributes to the completion gate for Computational Stage `07`
