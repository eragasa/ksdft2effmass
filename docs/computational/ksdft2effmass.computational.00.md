...
| [Bulk-silicon downstream sampling plan](bulk-silicon-downstream-sampling-plan.md) | Distinguishes symmetry-path, local-valley, uniform-Wannier, and tight-binding sampling and proposes the next tutorial slice | Planning only; does not activate a Task or authorize execution |
