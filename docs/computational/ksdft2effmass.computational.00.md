...
| [ABINIT basic tutorials and QE correspondence](abinit-tutorial-correspondence.md) | Bounded mapping of ABINIT basic1--basic4 to existing QE tutorial workflows | ABINIT 10.8.3 with Wannier90 3.1.0 support is installed; the exact [basic1 stage-1 preflight](abinit-basic1-stage1-preflight.md) awaits a human execution decision and no run is active |
