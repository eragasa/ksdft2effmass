...
# Task 09.02.01: Construct the continuum-to-Wannier embedding
...
Construct the continuum-to-Wannier embedding. The task produces the artifact Embedding operator required by the downstream dependency graph.

## Prerequisites

`G03`, [[ksdft2Effmass.computational.09.01.01|09.01.01]].
...
- [[ksdft2Effmass.computational.09.02.02|09.02.02]]
