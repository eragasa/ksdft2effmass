...
# Task 07.01.01: Define charge, relaxation, spin, and spin--orbit conventions
...
Define charge, relaxation, spin, and spin--orbit conventions. The task produces the artifact B:Si physical specification required by the downstream dependency graph.
