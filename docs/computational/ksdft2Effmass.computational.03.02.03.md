...
# Task 03.02.03: Freeze the reference Wannier operator
...
Freeze the reference Wannier operator. The task produces the artifact BulkSiWannier-v1 required by the downstream dependency graph.
...
- contributes to the completion gate for Computational Stage `03`
