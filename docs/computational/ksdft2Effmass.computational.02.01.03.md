...
# Task 02.01.03: Converge the Brillouin-zone sampling
...
Converge the Brillouin-zone sampling. The task produces the artifact $\mathbf{k}$-mesh convergence record required by the downstream dependency graph.
...
$\mathbf{k}$-mesh convergence record
