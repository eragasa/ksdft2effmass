...
# Task 05.01.03: Verify exact recovery on controlled gauge transformations
...
Verify exact recovery on controlled gauge transformations. The task produces the artifact Synthetic gauge-validation record required by the downstream dependency graph.

## Prerequisites

[[ksdft2Effmass.computational.05.01.02|05.01.02]], [[ksdft2Effmass.computational.01.03.02|01.03.02]].
...
Synthetic gauge-validation record
