...
# Task 04.04.02: Freeze the accepted model class and parameters
...
Freeze the accepted model class and parameters. The task produces the artifact BulkTBReference-v1 required by the downstream dependency graph.

## Prerequisites

[[ksdft2Effmass.computational.04.04.01|04.04.01]].
...
- contributes to the completion gate for Computational Stage `04`
