...
# Task 07.02.01: Construct multiband B:Si Wannier operators
...
Construct multiband B:Si Wannier operators. The task produces the artifact Doped Wannier candidates required by the downstream dependency graph.

## Prerequisites

[[ksdft2Effmass.computational.07.01.03|07.01.03]], `G03`.
...
- [[ksdft2Effmass.computational.07.02.02|07.02.02]]
