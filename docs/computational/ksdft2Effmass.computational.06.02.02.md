...
# Task 06.02.02: Validate doped subspaces and Wannier representations
...
Validate doped subspaces and Wannier representations. The task produces the artifact Doped Wannier validation records required by the downstream dependency graph.
...
Doped Wannier validation records
