...
# Task 04.03.01: Align the Wannier and TB orbital spaces
...
Align the Wannier and TB orbital spaces. The task produces the artifact Common operator representation required by the downstream dependency graph.

## Prerequisites

`G03`, [[ksdft2Effmass.computational.04.01.02|04.01.02]].
...
- [[ksdft2Effmass.computational.04.03.02|04.03.02]]
