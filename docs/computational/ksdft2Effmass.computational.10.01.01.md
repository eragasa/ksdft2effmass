...
# Task 10.01.01: Measure Wannier and alignment gauge-equivariance defects
...
Measure Wannier and alignment gauge-equivariance defects. The task produces the artifact Gauge-consistency record required by the downstream dependency graph.
