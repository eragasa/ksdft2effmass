...
# Task 07.03.02: Extract $\Delta\mathbf{H}_{\mathrm W,\mathrm B}$
...
Extract $\Delta\mathbf{H}_{\mathrm W,\mathrm B}$. The task produces the artifact Impurity-operator sequence required by the downstream dependency graph.
