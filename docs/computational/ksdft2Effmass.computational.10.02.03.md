...
# Task 10.02.03: Measure impurity extraction commutators
...
Measure impurity extraction commutators. The task produces the artifact $\varepsilon_{\mathrm{ext},d}$ records required by the downstream dependency graph.

## Prerequisites

[[ksdft2Effmass.computational.10.02.01|10.02.01]], [[ksdft2Effmass.computational.10.02.02|10.02.02]].
...
$\varepsilon_{\mathrm{ext},d}$ records
...
- [[ksdft2Effmass.computational.10.04.01|10.04.01]]
