...
# Task 07.01.02: Define the boron supercell and valence-subspace study
...
Define the boron supercell and valence-subspace study. The task produces the artifact Finite-size and subspace design required by the downstream dependency graph.

## Prerequisites

[[ksdft2Effmass.computational.07.01.01|07.01.01]], `G02`.
...
Finite-size and subspace design
...
- [[ksdft2Effmass.computational.07.01.03|07.01.03]]
