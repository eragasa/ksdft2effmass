...
# Task 02.01.04: Determine or freeze the lattice geometry
...
Determine or freeze the lattice geometry. The task produces the artifact Frozen bulk geometry required by the downstream dependency graph.
