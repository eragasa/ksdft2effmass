...
# Task 09.04.02: Determine $r_{c,\mathrm B}$
...
Determine $r_{c,\mathrm B}$. The task produces the artifact B crossover record required by the downstream dependency graph.
...
- [[ksdft2Effmass.computational.09.04.03|09.04.03]]
