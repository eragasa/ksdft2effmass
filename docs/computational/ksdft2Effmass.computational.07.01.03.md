...
# Task 07.01.03: Run B:Si first-principles calculations
...
Run B:Si first-principles calculations. The task produces the artifact Doped first-principles datasets required by the downstream dependency graph.
