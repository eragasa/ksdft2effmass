...
# Task 03.01.02: Select initial orbital projections
...
Select initial orbital projections. The task produces the artifact Projection set required by the downstream dependency graph.

## Prerequisites

[[ksdft2Effmass.computational.03.01.01|03.01.01]].
