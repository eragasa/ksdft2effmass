...
# Define controlled harness benchmarks

[Task index](index.md) · [Previous](./harness.telemetry.baseline.md) · [Next](./harness.telemetry.effectiveness-evaluation.md)
...
Define later controlled or matched Task comparisons only after telemetry completeness and instrumentation overhead are known.

## Parent and prerequisites

- Parent: `harness.telemetry`
- Depends on: `harness.telemetry.effectiveness-evaluation`
...
- Specify controlled or matched comparisons, verification floors, completeness requirements, and overhead accounting without executing a benchmark during the layout Task.

## Completion criteria

- A separately reviewable benchmark protocol is defined from established telemetry completeness and overhead; execution remains separately authorized.
