...
[Task index](index.md) · [Previous](./harness.simplification.docs-json.publication.hierarchy.md) · [Next](./harness.simplification.docs-json.schema-projection.md)

## Status

`completed`: completed; human dispositions recorded and hierarchy handoff accepted on 2026-08-09
...
- Parent: `harness.simplification.docs-json.publication`
- Depends on: `harness.simplification.api.action-object-grammar`

## Authority references

- .pi/chains/harness-simplification.chain.json
- .pi/evidence/docs-json/publication-triage.json
- docs/conferences
- docs/papers
- docs/publications/ksdft2effmass.publications.00.md
- harness/archive/task-control-v1/tasks/harness.simplification.docs-json.publication.triage.md
...
- This Task does not move, rename, delete, rewrite, publish, submit, or release files.

## Historical source

`harness/archive/task-control-v1/tasks/harness.simplification.docs-json.publication.triage.md` (`sha256:e847693467fbea4a543589e15560f545c6d56ccc1d3a27430e9eeb4a77ff8d2e`)
