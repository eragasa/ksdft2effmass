...
`inactive`: corrected inactive R2.6 final CLI placement and full-control-synchronization command work package; separate explicit human activation required and no automatic successor activation
