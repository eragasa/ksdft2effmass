...
- docs/architecture/v2/compiler-architecture.md
- docs/architecture/v2/index.md

## Authorized scope

- Maintain exactly one self-contained v1 architecture page describing implemented behavior, generated state, documented intention, known limitations, and historical execution without importing v2 objects into the implemented description.
- Maintain normative v2 pages containing only the selected development-harness, scientific-execution-harness, simulation, Campaign/CPN, artifact, control, compiler, persistence, and package target responsibilities.
...
- docs/architecture has the selected index, exactly one v1 page, exactly twelve normative v2 pages, and one migration page; docs/harness/architecture-v2 no longer exists.
- The v1 page is self-contained and accurately records implemented repository, harness, CPN, scientific-record, validation, calculator-execution, historical-execution, and limitation boundaries.
