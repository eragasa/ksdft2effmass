...
- Maintain normative v2 pages containing only the selected development-harness, scientific-execution-harness, simulation, Campaign/CPN, artifact, control, persistence, and package target responsibilities.
...
- docs/architecture has the selected index, exactly one v1 page, exactly eleven normative v2 pages, and one migration page; docs/harness/architecture-v2 no longer exists.
