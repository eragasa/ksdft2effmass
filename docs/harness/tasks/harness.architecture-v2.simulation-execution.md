...
- Do not modify harness.architecture-v2.plan outside its separately authorized planning-only lifecycle or use development Task status as scientific ScientificWorkflow state.
