...
`active`: awaiting_human_review: The exact human-authorized committed primary campaign executed once: 9 SCFs and 9 linked NSCFs each exited zero and emitted JOB DONE. Compact finite-setting observations and external artifact identities are retained. No retry, final cutoff or mesh selection, four-corner execution, successor activation, or scientific-validation claim occurred; the IEEE floating-point exception report recurred on all 18 invocations and remains unresolved and unclassified.
...
- The completed protected-execution authorization covered exactly the committed 9-SCF and 9-NSCF primary campaign. No retry, input revision, Wannier90 execution, four-corner follow-on, or other scientific executable is authorized; pseudopotential commit and redistribution remain prohibited.
- No final cutoff, mesh, or lattice constant is selected. The completed primary campaign supplies calculated finite-setting observations only; their human disposition remains pending.
