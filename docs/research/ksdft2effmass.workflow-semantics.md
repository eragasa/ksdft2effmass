...
The integration domain is periodic KS/GKS electronic structure for crystalline solids organized in Bloch fibers. Molecular-orbital and finite-system calculations are outside scope. The implemented workflow architecture and scientific boundary are described in [Architecture v1](../architecture/v1/index.md). Operational guidance is under [`docs/user-guide/`](../user-guide/).
