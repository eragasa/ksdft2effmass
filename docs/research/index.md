...
Research documentation records the scientific questions, assumptions, model
hierarchy, and limitations. Authoritative mathematical definitions remain in
the applicable versioned specifications.

## Start here

- [Research program](https://github.com/eragasa/ksdft2effmass/blob/dev/docs/research/ksdft2effmass.00.md)
