...
Status: `P2-A00`--`P2-A02` are `audited_and_cleared`; `P2-A03` is next but unstarted; P2 remains open and unaccepted at pending `P2-HC06`
...
The queue now has no active item and identifies P2-A03 as next but unstarted. P2-A03--P2-A06 remain pending read-only audits; P2-A07--P2-A11 remain pending artifact audits. `P2-HC05` is superseded without accepting P2, and renewed `P2-HC06` is pending. Recording or clearing an audit item does not authorize P2 acceptance, activate P3/H5, authorize external or scientific execution, or establish numerical verification, scientific validation, UQ, provenance truth, publication readiness, or release readiness.