...
Status: `P2-A00`--`P2-A02` are `audited_and_cleared`; `P2-A03` is active only for the bounded `ExternalExecutionResult` correction; P2 remains open and unaccepted after resolved `P2-HC06`
