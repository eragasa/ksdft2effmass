...
Status: `P2-A00`--`P2-A03` are `audited_and_cleared`; `P2-A04` remains open after the bounded `ArtifactLocationKind` correction, and `ManifestState` is the next human-audit target; P2 remains open and unaccepted after resolved `P2-HC06`
