...
Status: decomposed; publication normalization and the authority catalog are completed; no child Task is active and the parent is not independently executable
