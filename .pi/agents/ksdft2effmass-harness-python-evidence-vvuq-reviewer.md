---
name: ksdft2effmass-harness-python-evidence-vvuq-reviewer
package: ksdft2effmass
description: Independent read-only H2 software-verification evidence and VVUQ-boundary reviewer.
tools: read, bash
