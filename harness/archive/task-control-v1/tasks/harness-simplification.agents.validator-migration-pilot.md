...
Task identity: `harness-simplification.agents.validator-migration-pilot`

Authority: the current human instruction explicitly activates this one bounded cross-surface implementation pilot. The completed executable-tool placement contract is its prerequisite. No scientific, protected, dependency, release, broader migration, live-discovery, historical-retirement, delegation-validation, or SQLite work is authorized.
