...
> **GENERATED NON-AUTHORITATIVE REFERENCE. The selected Task JSON and chain are authoritative. This page cannot activate work and must never be used as a control input.**

## Identity and status

**Task-owned identity:** harness.simplification.docs-json.schema-projection

**Task-owned status:** completed

## Objective

**Task-owned objective:** For the bounded Task control-family pilot, replace manually synchronized control prose with one authoritative project-local JSON Task record and a deterministic complete non-authoritative Markdown reference page.

## Hierarchy

**Task-owned canonical parent:** harness.simplification.docs-json

## Prerequisites

**Task-owned Task prerequisites:**
- harness.simplification.docs-json.documentation-correction

**Task-owned external prerequisites:**
- None.
...
**Task-owned authority references:**
...
**Task-owned completion criteria:**
