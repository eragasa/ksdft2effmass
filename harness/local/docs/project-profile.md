...
current skill-capability validator, the controlled architecture-decision cases,
and the current Task schema/projection validator; it does not consume immutable
H4 checksum inventories. The route wrapper validates a closed structured result
