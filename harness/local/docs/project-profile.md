...
Maintained command scripts are repository command surfaces under `python/src/cli/`, not resources confined beneath the generic or local resource roots.
